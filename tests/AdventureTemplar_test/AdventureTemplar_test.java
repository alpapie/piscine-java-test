    ...
    void objectTemplar_instantiationAndToString() {
        try {
            ...
            assertThat(getName.invoke(dumbledore))
                    .withFailMessage("Name of templar should be Dumbledore, but was %s", getName.invoke(dumbledore))
                    .isEqualTo("Dumbledore");
            assertThat(getCurrentHealth.invoke(dumbledore))
                    .withFailMessage("Current Health of templar should be 30, but was %d", getCurrentHealth.invoke(dumbledore))
                    .isEqualTo(30);
            assertThat(getMaxHealth.invoke(dumbledore))
                    .withFailMessage("Max Health of templar should be 30, but was %d", getMaxHealth.invoke(dumbledore))
                    .isEqualTo(30);
            assertThat(getHealCapacity.invoke(dumbledore))
                    .withFailMessage("Heal Capacity of templar should be 8, but was %d", getHealCapacity.invoke(dumbledore))
                    .isEqualTo(8);
            assertThat(getShield.invoke(dumbledore))
                    .withFailMessage("Shield of templar should be 4, but was %d", getShield.invoke(dumbledore))
                    .isEqualTo(4);
            ...
            assertThat(getName.invoke(ronWeasley))
                    .withFailMessage("Name of templar should be Ron Weasley, but was %s", getName.invoke(ronWeasley))
                    .isEqualTo("Ron Weasley");
            assertThat(getCurrentHealth.invoke(ronWeasley))
                    .withFailMessage("Current Health of templar should be 0, but was %d", getCurrentHealth.invoke(ronWeasley))
                    .isEqualTo(0);
            assertThat(getMaxHealth.invoke(ronWeasley))
                    .withFailMessage("Max Health of templar should be 10, but was %d", getMaxHealth.invoke(ronWeasley))
                    .isEqualTo(10);
            assertThat(getHealCapacity.invoke(ronWeasley))
                    .withFailMessage("Heal Capacity of templar should be 1, but was %d", getHealCapacity.invoke(ronWeasley))
                    .isEqualTo(1);
            assertThat(getShield.invoke(ronWeasley))
                    .withFailMessage("Shield of templar should be 2, but was %d", getShield.invoke(ronWeasley))
                    .isEqualTo(2);
